<?php 
//Convert Number to Tanzanian Currency Format
class TanzanianCurrency{
  ...
  public function get_words(){
    $w="";
    $crore=(int)($this->Tsh/10000000);
    $this->Tsh=$this->Tsh%10000000;
    $w.=$this->single_word($crore,"Million ");
    $lakh=(int)($this->Tsh/100000);
    $this->Tsh=$this->Tsh%100000;
    $w.=$this->single_word($lakh,"Hundred Thousand ");
    $thousand=(int)($this->Tsh/1000);
    $this->Tsh=$this->Tsh%1000;
    $w.=$this->single_word($thousand,"Thousand  ");
    $hundred=(int)($this->Tsh/100);
