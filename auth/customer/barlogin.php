...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty(trim($_POST["bar_id"]))) {
        $barId_err = "Please select bar.";
    } else {
        $barId = trim($_POST["bar_id"]);
    }
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="input-group has-validation">
                                                <?PHP 
                                                    ...
                                                    if (isset($_GET["bar_name"]) && isset($_GET["bar_id"])) {
                                                        echo '<input type="hidden" class="form-control" name="bar_id" value="'.$_GET["bar_id"].'" />';
                                                        echo '<input type="text" readonly class="form-control" name="bar_name" value="'.$_GET["bar_name"].'" />';                                                     
                                                    } 
